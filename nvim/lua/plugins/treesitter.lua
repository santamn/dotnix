-- Tree-sitter パーサは Nix (modules/home/programs/neovim.nix) が全言語分を
-- ~/.local/share/nvim/site/parser に配置する (nvim-treesitter.withAllGrammars)。
--
-- nvim-treesitter main ブランチの install_dir 既定値が stdpath("data")/site で
-- ちょうど同じ場所を指すため、パーサの置き場所に関する設定は要らない。
